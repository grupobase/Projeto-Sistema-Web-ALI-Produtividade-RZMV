...
export function ResourceUsageChart() {
  ...
  const projects = [
    { name: "Rediseño de Sitio Web", percentage: 35, color: "bg-blue-500", translatedName: "Redesign do Site" },
    { name: "Implementación de CRM", percentage: 25, color: "bg-green-500", translatedName: "Implementação de CRM" },
    {
      name: "Campaña de Marketing Q2",
      percentage: 15,
      color: "bg-yellow-500",
      translatedName: "Campanha de Marketing Q2",
    },
    {
      name: "Desarrollo de App Móvil",
      percentage: 20,
      color: "bg-purple-500",
      translatedName: "Desenvolvimento de App Móvel",
    },
    { name: "Otros", percentage: 5, color: "bg-gray-500", translatedName: "Outros" },
  ]
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {projects.map((project, index) => (
          <div key={index} className="flex items-center gap-2">
            ...
            <div className="text-sm">{project.translatedName}</div>
