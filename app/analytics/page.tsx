          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Distribuição de recursos por projeto</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Utilização e eficiência de recursos a lo longo do tempo</CardDescription>
              </CardHeader>
              <CardContent>
